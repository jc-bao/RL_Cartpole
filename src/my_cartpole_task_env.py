...
class CartPoleStayUpEnv(cartpole_env.CartPoleEnv):
    ...
    def get_params(self):
        ...
        self.n_actions = rospy.get_param('/cartpole_v1/n_actions')
        self.min_pole_angle = rospy.get_param('/cartpole_v1/min_pole_angle')
        self.max_pole_angle = rospy.get_param('/cartpole_v1/max_pole_angle')
        self.max_base_velocity = rospy.get_param('/cartpole_v1/max_base_velocity')
        self.min_base_pose_x = rospy.get_param('/cartpole_v1/min_base_pose_x')
        self.max_base_pose_x = rospy.get_param('/cartpole_v1/max_base_pose_x')
        self.pos_step = rospy.get_param('/cartpole_v1/pos_step')
        self.running_step = rospy.get_param('/cartpole_v1/running_step')
        self.init_pos = rospy.get_param('/cartpole_v1/init_pos')
        self.wait_time = rospy.get_param('/cartpole_v1/wait_time')
        self.control_type = rospy.get_param('/cartpole_v1/control_type')
